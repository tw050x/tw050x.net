import { AccessTokenCookie, UseAccessTokenCookieResultingContext } from "@tw050x.net.library/user/middleware/use-access-token-cookie";
...
export const useAuthGate: Factory = () => async (context) => {
  ...
  if (context.incomingMessage.accessTokenCookie.authorised === null) {
    ...
    const portalServiceHost = readConfig('navigation.service.host');
