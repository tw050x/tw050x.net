...
/**
 * Props for the `<WelcomeMember />` component.
 */
export type Props = {};

/**
 * The `<WelcomeMember />` component.
 *
 * @param props
 * @returns {JSX.Element}
 */
const WelcomeMember: Component<Props> = (props) => {
  return (
    <>
      <div class="m-4">
        <Notice type="info">You have been invited to join the unnamed ecommerce platform.</Notice>
      </div>
      <div class="m-4">
