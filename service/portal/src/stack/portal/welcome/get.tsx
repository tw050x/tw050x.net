...
import { default as Welcome, Props as WelcomeDocumentProps } from "../../../template/document/Welcome";
...
export default defineServiceMiddleware([
  ...
  async (context) => {
    const welcomeDocumentProps: WelcomeDocumentProps = {
      menuInitiatorProps: {
        state: context.incomingMessage.uiMenuStateCookie.state,
      },
      welcomeComponent: 'WelcomeMember'
    }
    return void sendOKHTMLResponse(context, await <Welcome {...welcomeDocumentProps} />);
  }
])
